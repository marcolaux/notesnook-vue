...
exports.NoteHistory = void 0;
const crypto_js_1 = require("../utils/crypto.js");
const sql_collection_js_1 = require("../database/sql-collection.js");
const types_js_1 = require("../types.js");
const id_js_1 = require("../utils/id.js");
const session_content_js_1 = require("./session-content.js");
class NoteHistory {
    constructor(db) {
        this.db = db;
        this.name = "notehistory";
        this.sessionContent = new session_content_js_1.SessionContent(db);
        this.collection = new sql_collection_js_1.SQLCollection(db.sql, db.transaction, "notehistory", db.eventManager, db.sanitizer);
    }
    init() {
    ...
    // }
    get(noteId) {
        return new sql_collection_js_1.FilteredSelector("notehistory", this.db.sql().selectFrom("notehistory").where("noteId", "==", noteId));
    }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (yield this.collection.exists(sessionId)) {
                ...
                yield this.collection.upsert({
                    type: "session",
                    id: sessionId,
                    sessionContentId: (0, id_js_1.makeSessionContentId)(sessionId),
                    noteId,
    ...
    restore(sessionId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!note || !content)
                return;
            if (session.locked && (0, crypto_js_1.isCipher)(content.data)) {
                ...
                note.content =
                    content.data && content.type && !(0, crypto_js_1.isCipher)(content.data)
                        ? {
                            data: content.data,
                            type: content.type
                        }
