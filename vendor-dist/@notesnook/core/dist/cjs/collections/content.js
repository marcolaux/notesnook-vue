...
exports.Content = exports.EMPTY_CONTENT = void 0;
...
class Content {
    constructor(db) {
        this.db = db;
        this.name = "content";
        this.collection = new sql_collection_js_1.SQLCollection(db.sql, db.transaction, "content", db.eventManager, db.sanitizer);
    }
    init() {
    ...
    add(content) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (content.noteId && !content.id) {
                ...
                logger_js_1.logger.debug("finding content id", { id: content.noteId });
            ...
            const id = content.id || (0, id_js_1.getId)();
            const encryptedData = (0, crypto_js_1.isCipher)(content.data) ? content.data : undefined;
            ...
            if (content.id && (yield this.exists(content.id))) {
                const contentData = encryptedData
                    ...
                    : unencryptedData
                        ...
                        : undefined;
                if (contentData)
                    logger_js_1.logger.debug("updating content", {
                        id: content.noteId,
                ...
                logger_js_1.logger.debug("inserting content", {
                    id: content.noteId,
                    contentId: content.id,
    ...
    get(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!content || (0, types_js_1.isDeleted)(content))
                return;
    ...
    downloadMedia(groupId_1, contentItem_1) {
        return __awaiter(this, arguments, void 0, function* (groupId, contentItem, notify = true) {
            const content = yield (0, index_js_1.getContentFromData)(contentItem.type, contentItem.data);
            if (!content)
                return contentItem;
            contentItem.data = yield content.insertMedia((hashes) => __awaiter(this, void 0, void 0, function* () {
                ...
                for (const attachment of attachments) {
                    const src = yield this.db.attachments.read(attachment.hash, (0, attachments_js_1.getOutputType)(attachment));
    ...
    removeAttachments(id, hashes) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!contentItem || (0, crypto_js_1.isCipher)(contentItem.data))
                return;
            const content = yield (0, index_js_1.getContentFromData)(contentItem.type, contentItem.data);
            if (!content)
                return;
    ...
    preProcess(content) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (content.type === "tiny") {
                content.type = "tiptap";
                content.data = (0, migrations_js_1.tinyToTiptap)(content.data);
                changed = true;
            }
            // add block id on all appropriate nodes
            if (!content.data.includes("data-block-id")) {
                content.data = (yield (0, index_js_1.getContentFromData)(content.type, content.data)).insertBlockIds();
                changed = true;
            }
            return changed;
        });
