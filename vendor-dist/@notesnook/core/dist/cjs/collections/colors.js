...
exports.Colors = exports.DefaultColors = void 0;
...
class Colors {
    constructor(db) {
        this.db = db;
        this.name = "colors";
        this.collection = new sql_collection_js_1.SQLCollection(db.sql, db.transaction, "colors", db.eventManager, db.sanitizer);
    }
    init() {
    ...
    add(item) {
        return __awaiter(this, void 0, void 0, function* () {
            item.title = item.title ? (0, tags_js_1.sanitizeTag)(item.title) : item.title;
            ...
            const id = item.id || (0, id_js_1.getId)(item.dateCreated);
