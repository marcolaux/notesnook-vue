...
const index_js_1 = require("../content-types/index.js");
const title_format_js_1 = require("../utils/title-format.js");
const clone_js_1 = require("../utils/clone.js");
const content_js_1 = require("./content.js");
const index_js_2 = require("../utils/templates/index.js");
...
class Notes {
    constructor(db) {
        ...
        this.cache = { archived: [] };
        this.totalNotes = 0;
        this.collection = new sql_collection_js_1.SQLCollection(db.sql, db.transaction, "notes", db.eventManager, db.sanitizer);
    }
    init() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.db.transaction(() => __awaiter(this, void 0, void 0, function* () {
                ...
                if (item.content && item.content.data && item.content.type) {
                    logger_js_1.logger.debug("saving content", { id });
                    const { type, data } = item.content;
                    const content = yield (0, index_js_1.getContentFromData)(type, data);
                    if (!content)
                ...
                if (typeof item.title !== "undefined") {
                    item.title = item.title.replace(title_format_js_1.NEWLINE_STRIP_REGEX, " ");
                    dateEdited = Date.now();
                }
                if (!isUpdating || item.title === "") {
                    ...
                    item.title =
                        item.title ||
                            (0, title_format_js_1.formatTitle)(this.db.settings.getTitleFormat(), this.db.settings.getDateFormat(), this.db.settings.getTimeFormat(), this.db.settings.getDayFormat(), headlineTitle, this.totalNotes);
                }
                ...
                if (isUpdating) {
                    ...
                    if (item.isGeneratedTitle &&
                        title_format_js_1.HEADLINE_REGEX.test(titleFormat) &&
                        headlineTitle &&
                        (currentNoteTitleFields === null || currentNoteTitleFields === void 0 ? void 0 : currentNoteTitleFields.title) !== headlineTitle) {
                        item.title = titleFormat.replace(title_format_js_1.HEADLINE_REGEX, headlineTitle);
                    }
                    else if (item.title === "")
    ...
    note(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!note || (0, types_js_1.isTrashItem)(note) || (0, types_js_1.isDeleted)(note))
                return;
            return note;
        });
    }
    ...
    get all() {
        ...
        return this.collection.createFilter((qb) => qb
            .where((0, index_js_3.isFalse)("dateDeleted"))
            .where((0, index_js_3.isFalse)("deleted"))
            .where((0, index_js_3.isFalse)("archived")), (_a = this.db.options) === null || _a === void 0 ? void 0 : _a.batchSize);
    }
    get exportable() {
        var _a;
        return this.collection.createFilter((qb) => qb.where((0, index_js_3.isFalse)("dateDeleted")).where((0, index_js_3.isFalse)("deleted")), (_a = this.db.options) === null || _a === void 0 ? void 0 : _a.batchSize);
    }
    // isTrashed(id: string) {
    ...
    get favorites() {
        ...
        return this.collection.createFilter((qb) => qb
            .where((0, index_js_3.isFalse)("dateDeleted"))
            .where((0, index_js_3.isFalse)("deleted"))
            .where((0, index_js_3.isFalse)("archived"))
    ...
    archive(state, ...ids) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (state) {
                (0, array_js_1.addItems)(this.cache.archived, ...ids);
            }
            else {
                (0, array_js_1.deleteItems)(this.cache.archived, ...ids);
            }
        });
    }
    ...
    export(noteOrId, options) {
        return __awaiter(this, void 0, void 0, function* () {
                ...
                ? yield (() => __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (!contentItem) {
                        ...
                        if (rawContent && rawContent.locked)
                            return false;
                        contentItem = rawContent || (0, content_js_1.EMPTY_CONTENT)(note.id);
                    }
            ...
            return (options === null || options === void 0 ? void 0 : options.disableTemplate)
                ? contentString
                : (0, index_js_2.buildFromTemplate)(format, Object.assign(Object.assign({}, note), { tags,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            for (const id of ids) {
                ...
                const content = note.contentId
                    ...
                    : undefined;
                const duplicateId = yield this.db.notes.add(Object.assign(Object.assign({}, (0, clone_js_1.clone)(note)), { id: undefined, readonly: false, favorite: false, pinned: false, contentId: undefined, title: note.title + " (Copy)", dateEdited: undefined, dateCreated: undefined, dateModified: undefined }));
                const contentId = yield this.db.content.add(Object.assign(Object.assign({}, (0, clone_js_1.clone)(content)), { id: undefined, noteId: duplicateId, dateResolved: undefined, dateEdited: undefined, dateCreated: undefined, dateModified: undefined }));
    ...
    contentBlocks(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!content || content.locked)
                return [];
            return (yield (0, index_js_1.getContentFromData)(content.type, content.data)).extract("blocks").blocks;
        });
    }
    contentBlocksWithLinks(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!content || content.locked)
                return [];
            return (yield (0, index_js_1.getContentFromData)(content.type, content.data)).extract("blocksWithLink").blocks;
        });
    }
    internalLinks(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!content || content.locked)
                return [];
            return (yield (0, index_js_1.getContentFromData)(content.type, content.data)).extract("internalLinks").internalLinks;
        });
    }
    deleteExpiredNotes() {
        return __awaiter(this, void 0, void 0, function* () {
            const expiredItems = yield this.db
                ...
                .selectFrom("notes")
                .where("type", "!=", "trash")
                .where((0, kysely_1.sql) `expiryDate ->> '$.value'`, "<", Date.now())
                .select("id as noteId")
                .execute();
