...
const sql_cached_collection_js_1 = require("../database/sql-cached-collection.js");
...
const KEY_IDS = Object.fromEntries(Object.keys(defaultSettings).map((key) => [key, (0, id_js_1.makeId)(key)]));
class Settings {
    constructor(db) {
        this.name = "settings";
        this.collection = new sql_cached_collection_js_1.SQLCachedCollection(db.sql, db.transaction, "settings", db.eventManager, db.sanitizer);
    }
    init() {
