...
function fuzzy(query, items, getIdentifier, fields, options = {}) {
    ...
    if (sanitizedQuery !== query) {
        for (const [key, value] of fuzzyMatch(sanitizedQuery, items, getIdentifier, fields, options)) {
...
function fuzzyMatch(query, items, getIdentifier, fields, options = {}) {
    ...
    for (const item of items) {
        ...
        for (const field in fields) {
            ...
            const result = (0, fuzzyjs_1.match)(query, value);
            if (!result.match)
                continue;
            const oldMatch = results.get(identifier);
            const clonedItem = (oldMatch === null || oldMatch === void 0 ? void 0 : oldMatch.item) || (0, clone_js_1.clone)(item);
            if (options.suffix || options.prefix) {
                clonedItem[field] = (0, fuzzyjs_1.surround)(`${clonedItem[field]}`, {
