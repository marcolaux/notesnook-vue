...
exports.highlightInternalLinks = highlightInternalLinks;
exports.ellipsize = ellipsize;
const internal_link_js_1 = require("./internal-link.js");
...
function extractInternalLinks(block) {
    ...
    for (const match of matches) {
        ...
        const link = (0, internal_link_js_1.parseInternalLink)(url);
        if (!link)
            continue;
