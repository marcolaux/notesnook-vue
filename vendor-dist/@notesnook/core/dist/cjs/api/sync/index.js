...
const collector_js_1 = __importDefault(require("./collector.js"));
const merger_js_1 = __importStar(require("./merger.js"));
const auto_sync_js_1 = require("./auto-sync.js");
...
class SyncManager {
    ...
    start(options) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            try {
                if (yield (0, common_js_1.checkSyncStatus)(this.db.eventManager, common_js_1.SYNC_CHECK_IDS.autoSync))
...
class Sync {
    constructor(db) {
        this.db = db;
        this.logger = logger_js_1.logger.scope("Sync");
        this.syncConnectionMutex = new async_mutex_1.Mutex();
        this.conflictedNoteIds = [];
        this.uncachedAttachments = [];
        this.collector = new collector_js_1.default(db);
        this.merger = new merger_js_1.default(db);
        this.autoSync = new auto_sync_js_1.AutoSync(db, 1000);
        this.devices = new devices_js_1.SyncDevices(db.kv, db.tokenManager);
        db.eventManager.subscribe(common_js_1.EVENTS.userLoggedOut, () => __awaiter(this, void 0, void 0, function* () {
            var _a;
    ...
    start(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!this.connection)
                return;
            if (!(yield (0, common_js_1.checkSyncStatus)(this.db.eventManager, common_js_1.SYNC_CHECK_IDS.sync))) {
            ...
            this.connection.onclose((error = new Error("Connection closed.")) => {
                this.db.eventManager.publish(common_js_1.EVENTS.syncAborted);
            ...
            try {
                for (var _e = true, _f = __asyncValues(this.collector.collect(100, isForceSync)), _g; _g = yield _f.next(), _a = _g.done, !_a; _e = true) {
                    ...
                    if (result) {
                        ...
                        (0, common_js_1.sendSyncProgressEvent)(this.db.eventManager, "upload", done);
                    }
                    else {
    ...
    stop(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.db.eventManager.publish(common_js_1.EVENTS.syncCompleted);
        });
    }
    cancel() {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    onPushCompleted(deviceId) {
        return __awaiter(this, void 0, void 0, function* () {
            this.db.eventManager.publish(common_js_1.EVENTS.databaseSyncRequested, true, false, deviceId);
        });
    }
    processChunk(chunk, keys, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const item of chunk.items) {
                const keyVersion = (_a = item.keyVersion) !== null && _a !== void 0 ? _a : types_js_2.KEY_VERSION.LEGACY;
            ...
            const collectionType = types_js_2.SYNC_COLLECTIONS_MAP[itemType];
            if (!collectionType) {
            ...
            if (itemType === "note" || itemType === "content") {
                items.forEach((item) => this.db.eventManager.publish(common_js_1.EVENTS.syncItemMerged, item));
    ...
    createConnection(options) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.connection)
                return;
            const { HubConnectionBuilder, HttpTransportType, JsonHubProtocol } = yield Promise.resolve().then(() => __importStar(require("@microsoft/signalr")));
            const tokenManager = new token_manager_js_1.default(this.db.kv, this.db.eventManager);
            this.connection = new HubConnectionBuilder()
                .withUrl(`${constants_js_1.default.API_HOST}/hubs/sync/v2`, {
                ...
                logger: {
                    log: (level, message) => {
                        const scopedLogger = logger_js_1.logger.scope("SignalR::SyncHub");
                        switch (level) {
                            case LogLevel.Critical:
                                return scopedLogger.fatal(new Error(message));
                            case LogLevel.Error: {
                                this.db.eventManager.publish(common_js_1.EVENTS.syncAborted, message);
            ...
            this.connection.on("SendVaultKey", (vaultKey) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (vaultKey &&
                    ...
                    if (!vault)
                        yield (0, migrations_js_1.migrateVaultKey)(this.db, vaultKey, 5.9, common_js_1.CURRENT_DATABASE_VERSION);
                }
                return true;
            }));
            this.connection.on("SendItems", (chunk) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (!keys || !keys.length) {
                    ...
                    this.db.eventManager.publish(common_js_1.EVENTS.userSessionExpired);
                    return false;
                }
                ...
                (0, common_js_1.sendSyncProgressEvent)(this.db.eventManager, `download`, chunk.count);
                return true;
            }));
            this.connection.on("SendMonographs", (monographs) => __awaiter(this, void 0, void 0, function* () {
                ...
                yield this.db.monographs.refresh().catch(this.logger.error);
                this.db.eventManager.publish(common_js_1.EVENTS.monographsUpdated, ids);
                return true;
            }));
            this.connection.on("SendInboxItems", (inboxItems) => __awaiter(this, void 0, void 0, function* () {
                ...
                yield (0, merger_js_1.handleInboxItems)(inboxItems, this.db);
                return true;
            }));
        });
    }
...
function deserializeItem(item, type, version, database) {
    return __awaiter(this, void 0, void 0, function* () {
        item.remote = true;
        item.synced = true;
        let migrationResult = yield (0, migrations_js_1.migrateItem)(item, version, common_js_1.CURRENT_DATABASE_VERSION, (0, types_js_1.isDeleted)(item) ? type : item.type, database, "sync");
        ...
        if ((0, types_js_1.isTrashItem)(item)) {
            migrationResult = yield (0, migrations_js_1.migrateItem)(item, version, common_js_1.CURRENT_DATABASE_VERSION, item.itemType, database, "sync");
            if (migrationResult === "skip")
                return;
        }
        const itemType = (0, types_js_1.isDeleted)(item)
            ? type
