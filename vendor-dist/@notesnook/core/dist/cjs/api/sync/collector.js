...
class Collector {
    constructor(db) {
        this.db = db;
        this.logger = logger_js_1.logger.scope("SyncCollector");
    }
    hasUnsyncedChanges() {
        return __awaiter(this, void 0, void 0, function* () {
            for (const itemType of types_js_1.SYNC_ITEM_TYPES) {
                const collectionKey = types_js_1.SYNC_COLLECTIONS_MAP[itemType];
...
function toSyncItem(ids, ciphers, keyVersion) {
    ...
    for (let i = 0; i < ids.length; ++i) {
        ...
        cipher.v = common_js_1.CURRENT_DATABASE_VERSION;
        cipher.id = id;
