...
exports.IndexedCollection = void 0;
const array_js_1 = require("../utils/array.js");
const indexer_js_1 = __importDefault(require("./indexer.js"));
/**
 * @deprecated only kept here for migration purposes
 */
class IndexedCollection {
    constructor(storage, type) {
        this.indexer = new indexer_js_1.default(storage, type);
    }
    clear() {
    ...
    iterate(chunkSize) {
        return __asyncGenerator(this, arguments, function* iterate_1() {
            const chunks = (0, array_js_1.toChunks)(this.indexer.indices, chunkSize);
