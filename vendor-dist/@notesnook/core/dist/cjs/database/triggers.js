...
exports.dropTriggers = dropTriggers;
...
function createTriggers(db) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield db.schema
            ...
            rowid: (0, kysely_1.sql) `new.rowid`,
            id: (0, kysely_1.sql) `new.id`,
            data: (0, kysely_1.sql) `IIF(new.locked == 1, '', new.data)`,
            noteId: (0, kysely_1.sql) `new.noteId`
        }))
            .execute();
        yield db.schema
            ...
            .addQuery((c) => c.insertInto("content_fts").values({
            content_fts: kysely_1.sql.lit("delete"),
            rowid: kysely_1.sql.ref("old.rowid"),
            id: kysely_1.sql.ref("old.id"),
            data: (0, kysely_1.sql) `IIF(old.locked == 1, '', old.data)`,
            noteId: kysely_1.sql.ref("old.noteId")
        }))
            .execute();
        yield db.schema
        ...
        yield db.schema
            ...
            rowid: (0, kysely_1.sql) `new.rowid`,
            id: kysely_1.sql.ref("new.id"),
            title: kysely_1.sql.ref("new.title")
        }))
            .execute();
        yield db.schema
            ...
            .addQuery((c) => c.insertInto("notes_fts").values({
            notes_fts: kysely_1.sql.lit("delete"),
            rowid: kysely_1.sql.ref("old.rowid"),
            id: kysely_1.sql.ref("old.id"),
            title: kysely_1.sql.ref("old.title")
        }))
            .execute();
        yield db.schema
