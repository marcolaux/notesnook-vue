...
exports.SQLCachedCollection = void 0;
...
class SQLCachedCollection {
    constructor(sql, startTransaction, type, eventManager, sanitizer) {
        this.type = type;
        this.cache = new Map();
        this.collection = new sql_collection_js_1.SQLCollection(sql, startTransaction, type, eventManager, sanitizer);
    }
    init() {
    ...
    exists(id) {
        ...
        return !!item && !(0, types_js_1.isDeleted)(item);
    }
    count() {
    ...
    items(ids) {
        ...
        if (ids) {
            ...
            for (const [_key, value] of this.cache) {
                if (!value || (0, types_js_1.isDeleted)(value))
                    continue;
                items.push(value);
            }
        }
