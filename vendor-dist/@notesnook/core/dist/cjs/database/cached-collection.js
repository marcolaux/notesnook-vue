...
class CachedCollection {
    constructor(storage, type) {
        this.cache = new Map();
        this.collection = new indexed_collection_js_1.IndexedCollection(storage, type);
    }
    init() {
    ...
    exists(id) {
        ...
        return this.collection.exists(id) && !!item && !(0, types_js_1.isDeleted)(item);
    }
    has(id) {
    ...
    items(map) {
        ...
        this.cache.forEach((value) => {
            var _a;
            if ((0, types_js_1.isDeleted)(value))
                return;
