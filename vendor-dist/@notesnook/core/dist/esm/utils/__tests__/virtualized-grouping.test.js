...
function createVirtualizedGrouping(length, groupSize, batchSize) {
    ...
    return new VirtualizedGrouping(items.length, batchSize, () => Promise.resolve(ids), (start, end) => __awaiter(this, void 0, void 0, function* () {
        return ({
...
test("load first batch with a single group", (t) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c;
...
test("load first batch with a multiple groups", (t) => __awaiter(void 0, void 0, void 0, function* () {
...
test("load last batch with a single group", (t) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c;
    const grouping = createVirtualizedGrouping(100, 10, 10);
...
test("load last batch with a multiple groups", (t) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c, _d, _e, _f, _g, _h, _j;
    const grouping = createVirtualizedGrouping(100, 2, 10);
...
test("group spanning multiple batches (down)", (t) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c;
...
test("single group in all batches", (t) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
...
test("group at start of each batch", (t) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const grouping = createVirtualizedGrouping(100, 10, 10);
...
test("group spanning multiple batches (up)", (t) => __awaiter(void 0, void 0, void 0, function* () {
