...
import { HTMLParser, extractHeadline, extractTitle, getDummyDocument } from "../utils/html-parser.js";
import { HTMLRewriter } from "../utils/html-rewriter.js";
import { isNoteLink, parseInternalLink } from "../utils/internal-link.js";
...
export class Tiptap {
    ...
    resolveAttachments(resolve) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const elements = findAll((e) => !!e.attribs[ATTRIBUTES.hash], document.childNodes);
    ...
    extract(...types) {
        ...
        if (types.includes("blocksWithLink")) {
            result.blocks.push(...findAll((element) => {
                return (!!element.attribs[ATTRIBUTES.blockId] &&
                    element.childNodes.some((node) => {
                        ...
                        return isTag(node) &&
                            ...
                            ((_a = parseInternalLink(node.attribs.href)) === null || _a === void 0 ? void 0 : _a.type) === "note";
                    }));
        ...
        if (types.includes("internalLinks")) {
            result.internalLinks.push(...findAll((e) => e.tagName === "a" && !!e.attribs.href && isNoteLink(e.attribs.href), document.childNodes)
