...
export class Monographs {
    ...
    unpublish(noteId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const deviceId = yield this.db.kv().read("deviceId");
            yield http.delete(`${Constants.API_HOST}/monographs/${noteId}?deviceId=${deviceId}`, token);
    ...
    metadata(monographId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const token = yield this.db.tokenManager.getAccessToken();
                const info = (yield http.get(`${Constants.API_HOST}/monographs/${monographId}/metadata`, token));
                return info;
            }
            catch (_a) {
