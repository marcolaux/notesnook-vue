...
export class InboxApiKeys {
    ...
    get() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!token)
                return;
            const inboxApiKeys = yield http.get(`${constants.API_HOST}${ENDPOINTS.inboxApiKeys}`, token);
            return inboxApiKeys;
        });
    }
    revoke(key) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!token)
                return;
            yield http.delete(`${constants.API_HOST}${ENDPOINTS.inboxApiKeys}/${key}`, token);
        });
    }
    create(name, expiryDuration) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield http.post.json(`${constants.API_HOST}${ENDPOINTS.inboxApiKeys}`, payload, token);
        });
    }
}
