...
import { KEY_VERSION } from "./sync/types.js";
...
class UserManager {
    ...
    signup(email, password) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.tokenManager.saveToken(yield http.post(`${constants.API_HOST}${ENDPOINTS.signup}`, {
                email,
    ...
    authenticatePassword(email, password, hashedPassword, sessionExpired) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield this.tokenManager.saveToken(yield http
                    .post(`${constants.AUTH_HOST}${ENDPOINTS.token}`, {
                    ...
                    if (e instanceof Error && e.message === "Password is incorrect.") {
                        ...
                        usesFallback = true;
                        return yield http.post(`${constants.AUTH_HOST}${ENDPOINTS.token}`, {
                            grant_type: "mfa_password",
                            client_id: "notesnook",
                            scope: "notesnook.sync offline_access IdentityServerApi",
                            password: hashedPassword
    ...
    deleteUser(password) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!token || !user)
                return;
            yield http.post(`${constants.API_HOST}${ENDPOINTS.deleteUser}`, {
            ...
            try {
                ...
                if (user) {
                    ...
                    if (oldUser &&
                        ...
                        yield this.tokenManager._refreshToken(true);
                        this.db.eventManager.publish(EVENTS.userSubscriptionUpdated, user.subscription);
                    }
    ...
    discardInboxKeys() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!user)
                return;
            const token = yield this.tokenManager.getAccessToken();
            yield http.patch.json(`${constants.API_HOST}${ENDPOINTS.user}`, { inboxKeys: { public: null, private: null } }, token);
    ...
    _updatePassword(type, data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield http.patch.json(`${constants.API_HOST}/users/password/${type}`, {
