...
@notesnook/editor (GPL-3.0), table-cell/utils.ts — only the import source
changed (`@tiptap/core` → `@tiptap/vue-3`, which re-exports core).
*/
import type { Attribute } from "@tiptap/vue-3";
