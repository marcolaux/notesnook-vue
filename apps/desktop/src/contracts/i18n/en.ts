...
export default {
  ...
  settings: {
    ...
    backup: {
      ...
      backup: "Backup",
      backupHint: "“Backup (notes only)” saves a `.nnbackup` file you choose. “Backup with attachments” writes a dated folder into your backup directory and deduplicates attachments across backups (so each file is stored once).",
      backupFullNeedsDir: "“Backup with attachments” writes into your backup directory. Choose one to continue.",
      restoreBackup: "Restore backup",
      restorePasswordPlaceholder: "Password (optional — for encrypted backups)",
      restore: "Restore",
      restoreHint: "“Restore” imports a `.nnbackup` (notes-only) file. “Restore from folder” restores a “Backup with attachments” folder.",
      restoreFromDir: "Restore from folder",
      restoreFromDirHint: "Select the dated `…-full` folder inside your backup directory.",
      restoreDirOutside: "That folder isn’t inside your backup directory.",
      createNowPrompt: "Automatic backups are now enabled. Create a backup now?",
      createNowTitle: "Automatic backups enabled",
      notifyTitle: "Automatic backup created",
      notifyBodyPartial: "Notes-only backup created.",
      notifyBodyFull: "Backup with attachments created ({n} included).",
      notifyBodySkipped: "{n} attachment(s) not cached locally — skipped (sync will re-fetch).",
    ...
    attachments: {
      ...
      imageCompressionAsk: "Ask every time",
      imageCompressionEnable: "Compress",
      imageCompressionDisable: "Don’t compress",
      imageCompressionHint: "Whether to compress images pasted or dropped into notes. Per-account.",
  ...
  editorToolbar: {
    ...
    publish: "Publish",
    published: "Published",
    updateMonograph: "Update published note",
  ...
  login: {
    ...
    testing: "Testing…",
    serverConnected: "{field}: connected.",
    serverUnreachable: "{field}: could not connect. Check the URL and that the server is running.",
    serverWrongId: "{field}: wrong server — this URL points at a different service (reported id “{id}”).",
    serverIncompatible: "{field}: incompatible server version ({version}). The server may need updating.",
